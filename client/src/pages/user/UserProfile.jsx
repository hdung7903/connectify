...
import { UserOutlined, UserAddOutlined, CameraOutlined, SettingOutlined, HomeOutlined, EnvironmentOutlined, LikeOutlined, MessageOutlined, ShareAltOutlined, MailOutlined, WarningFilled } from '@ant-design/icons';
            ...
            >
                ...
                <Row gutter={16} justify="center" align="middle">
                    ...
                    <Col xs={24} sm={16} md={18} style={{ height: "100%", minHeight: 200 }}>
                        <Title level={2} style={{ marginBottom: 0 }}>Jane Doe</Title>
                        <Text type="secondary" style={{ fontSize: '16px' }}>@janedoe</Text>
                        <Row gutter={16} style={{ marginTop: 15 }}>
                            ...
                            <Col>
                                <Button icon={<WarningFilled />}>Report</Button>
                            </Col>
                        </Row>
                    </Col>
                </Row>
                        ...
                        <Card key={post.id} style={{ marginTop: 16 }}>
                            <Space>
                                ...
                                <Space direction="vertical" size={4}>
                                    <Text strong style={{ marginLeft: 8 }}>Jane Doe</Text>
